	...
	return (
		<div className='mx-20'>
			<div className='hero flex flex-col'>
				<span className='-mb-16 pl-16 text-8xl uppercase text-left'>Learn</span>
				<span className='-mb-16 uppercase text-[16rem] text-center'>
					The <span className='text-gradient'>Future</span>
				</span>
				<span className=' pr-16 uppercase text-8xl text-right'>way</span>
			</div>
			<p className='mx-16 w-1/3 -mt-20'>
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum iusto
				odit vel molestias magni, unde ipsa laboriosam quos fugiat enim voluptas
				amet nihil, voluptatem repellat tempora minima sint architecto! Ducimus.
			</p>
